...
BOOST_FIXTURE_TEST_CASE( setparams, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL(success(), push_action( name(config::system_account_name), 
                                               "setparams"_n,
...
void static setkvparams_common( const eosio::chain::kv_database_config& params, eosio_system_tester& system_tester ) {
   ...
   elog("active_params ${active_params}", ("active_params", active_params));
   elog("params ${active_params}", ("active_params", params));
...
BOOST_FIXTURE_TEST_CASE( rex_rounding_issue, eosio_system_tester ) try {
   ...
   for (auto& w : whales) {
      ...
      stake_with_transfer("eosio"_n, w, core_sym::from_string("1000.0000"), core_sym::from_string("1000.0000"));
   ...
   for(auto& rb : rexborrowers) {
      ...
      buyram("eosio"_n, rb, core_sym::from_string("10.0000"));
      issue_and_transfer(rb, core_sym::from_string("1000000.0000"));
      stake_with_transfer("eosio"_n, rb, core_sym::from_string("1000.0000"), core_sym::from_string("1000.0000"));
      ...
      // BOOST_REQUIRE_EQUAL( success(), push_action( rb, "buyrex"_n, mvo()("from", rb)("amount", core_sym::from_string("1000000.0000")) ) );
   }
   // get accounts into rex
   for(auto& acct : accounts){
      stake_with_transfer("eosio"_n, acct, core_sym::from_string("1000.0000"), core_sym::from_string("1000.0000"));
   ...
   auto check_tables = [&] (const name& acct) {
...
BOOST_FIXTURE_TEST_CASE( b1_vesting, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), vote( b1, { }, "proxyaccount"_n ) );
